...
load_path = 'Qianyan_fgm102.pth'
output_file = 'Qinyan_train_sentence_fgm.json'
...
if __name__ == '__main__':
    # train_teacher
    train_ = data_split(train_data[:int(len(train_data)*0.8)], fold, 1, 'train')
    valid_ = data_split(train_data[int(len(train_data)*0.8):], fold, 1, 'valid')
