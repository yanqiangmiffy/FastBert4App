...
load_path = 'Qianyan_lookahead.pth'
output_file = 'Qinyan_lookahead.json'
...
if __name__ == '__main__':
    # train_teacher
    train_ = data_split(train_data[:int(len(train_data)*0.99)], fold, 1, 'train')
    valid_ = data_split(train_data[int(len(train_data)*0.99):], fold, 1, 'valid')
